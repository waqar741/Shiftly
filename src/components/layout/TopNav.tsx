...
import { Search, Network, ChevronDown, Bell, Menu } from "lucide-react";
...
export function TopNav({ onMenuClick }: { onMenuClick?: () => void }) {
  ...
  return (
    <header className="h-12 bg-white border-b border-slate-200 flex items-center justify-between px-4 md:px-6 flex-shrink-0 z-20">
      ...
      <div className="flex items-center space-x-3 md:space-x-5 ml-2 md:ml-4">
        ...
        <div className="flex items-center border-l border-slate-200 pl-3 md:pl-5">
